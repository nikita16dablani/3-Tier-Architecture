...
// employeeId pr substring apply kiya and usko 1 pass kiya to 1 ke ek pehela ka hata means A hata
}catch(Exception exception)
{
...
connection=DAOConnection.getConnection();
PreparedStatement preparedStatement;
// we need to check record h ya nhi so taking the smallest field gender
